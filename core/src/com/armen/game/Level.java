...
import com.armen.game.objects.Clouds;
import com.armen.game.objects.Feather;
import com.armen.game.objects.GoldCoin;
import com.armen.game.objects.Mountains;
import com.armen.game.objects.Rock;
import com.armen.game.objects.WaterOverlay;
...
public class Level {
    ...
    private void init(String filename) {
        ...
        //scan pixels from top-left to bttom-right
        int lastPixel = -1;
        for (int pixelY = 0; pixelY < pixmap.getHeight(); pixelY++) {
            for (int pixelX = 0; pixelX < pixmap.getWidth(); pixelX++) {
                ...
                //get color of current pixel as 32bit RGBA value
                ...
                // unknown object/pixel color
                    ...
                    Gdx.app.error(LOG_TAG, "Unknown object at x<" + pixelX + "> y<"
        ...
        // free memory
        pixmap.dispose();
        Gdx.app.debug(LOG_TAG, "level '" + filename + "' loaded");
    }
