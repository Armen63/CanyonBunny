...
public class Clouds extends AbstractGameObject {
    ...
    private void init() {
        ...
        regClouds.add(com.armen.game.Assets.instance.levelDecoration.cloud01);
        regClouds.add(com.armen.game.Assets.instance.levelDecoration.cloud02);
        regClouds.add(com.armen.game.Assets.instance.levelDecoration.cloud03);
        int distFac = 5;
