...
public class Mountains extends AbstractGameObject {
    ...
    private void init() {
        dimension.set(10, 2);
        regMountainLeft = com.armen.game.Assets.instance.levelDecoration.mountainLeft;
        regMountainRight = com.armen.game.Assets.instance.levelDecoration.mountainRight;
    ...
    private void drawMountain(SpriteBatch batch, float offsetX, float offsetY, float tintColor, float parallaxSpeedX) {
        ...
        for (int i = 0; i < mountainLength; i++) {
            ...
            batch.draw(
                    reg.getTexture(),
                    origin.x + xRel + position.x * parallaxSpeedX, position.y + origin.y + yRel,
                    origin.x, origin.y,
