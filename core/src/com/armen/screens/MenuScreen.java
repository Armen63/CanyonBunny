...
import com.armen.screens.transition.ScreenTransitionFade;
...
public class MenuScreen extends AbstractGameScreen {
    public static final String LOG_TAG = MenuScreen.class.getName();
    ...
    private SelectBox<com.armen.util.CharacterSkin> selCharSkin;
    ...
    private void onCharSkinSelected(int index) {
        com.armen.util.CharacterSkin skin = com.armen.util.CharacterSkin.values()[index];
    ...
    private Table buildOptionsWindowLayer() {
        ...
        //+ Seperatorand Buttons(Save, Cancel)
    ...
    private Table buildOptWinSkinSelection() {
        ...
        selCharSkin = new SelectBox<com.armen.util.CharacterSkin>(skinLibGdx);
        selCharSkin.setItems(com.armen.util.CharacterSkin.values());
        selCharSkin.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                onCharSkinSelected(((SelectBox<com.armen.util.CharacterSkin>)
